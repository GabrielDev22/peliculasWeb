...
function App() {
  ...
  const API_KEY = '70d53d972c4138881fc5dbb727664306'
  ...
  return (
   <div>
    ...
    {/* Aqui va todo el contenedor del baner */}  
    <div>
      <main>
          {movie ? (
            <div 
   ...
   {/*  contenedor que a mostrar poster de las peliculas actuales  */}
